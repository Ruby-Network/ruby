((window, factory) => {
    ...
    <div class="chrome-tab">
      ...
      <div class="chrome-tab-content">
        ...
        <div class="chrome-tab-close">
            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'><path stroke='var(--text-color)' stroke-linecap='square' stroke-width='1.5' d='M0 0 L8 8 M8 0 L0 8'></path></svg>
        </div>
      </div>
    </div>
  `
  ...
  const defaultTapProperties = {
    title: 'Search',
    favicon: `${window.origin}/favicon.ico`
  }

  let instanceId = 0

  class ChromeTabs {
    constructor(newButton = false) {
      this.draggabillies = []
    ...
    setupNewButton() {
      ...
      tabEl.querySelector('.chrome-tab-favicon').style.backgroundImage = `url('/add-favicon.png')`
